...
public final class MethodRequestParameter {
	 ...
	 */
	public MethodRequestParameter(int classId, ObisCode obisCode, int methodId) {
	 ...
	 */
	public MethodRequestParameter(int classId, ObisCode obisCode, int methodId, DataObject methodParameter) {
