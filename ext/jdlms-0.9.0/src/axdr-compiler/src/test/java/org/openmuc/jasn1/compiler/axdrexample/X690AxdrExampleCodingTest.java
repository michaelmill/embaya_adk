...
import org.openmuc.jasn1.compiler.axdrexample.generated.ChildInformation;
import org.openmuc.jasn1.compiler.axdrexample.generated.Date;
import org.openmuc.jasn1.compiler.axdrexample.generated.EmployeeNumber;
import org.openmuc.jasn1.compiler.axdrexample.generated.Gender;
import org.openmuc.jasn1.compiler.axdrexample.generated.Name;
import org.openmuc.jasn1.compiler.axdrexample.generated.PersonnelRecord;
import org.openmuc.jasn1.compiler.axdrexample.generated.PersonnelRecord.SubSeqOf_children;
...
public class X690AxdrExampleCodingTest {
	...
	public void encodingDecoding() throws IOException {
		...
		AxdrByteArrayOutputStream axdrOS = new AxdrByteArrayOutputStream(1000);

		Name name = new Name(new AxdrVisibleString("Random".getBytes(charset)), new AxdrVisibleString(
				"RG".getBytes(charset)), new AxdrVisibleString("Guy".getBytes(charset)));

		EmployeeNumber number = new EmployeeNumber(123456);

		Date dateOfHire = new Date("20120901".getBytes(charset));

		Name nameOfSpouse = new Name(new AxdrVisibleString("Melissa".getBytes(charset)), new AxdrVisibleString(
				"MG".getBytes(charset)), new AxdrVisibleString("Guy".getBytes(charset)));

		SubSeqOf_children children = new SubSeqOf_children();

		children.add(new ChildInformation(new Name(new AxdrVisibleString("Junior".getBytes(charset)),
		...
		children.add(new ChildInformation(new Name(new AxdrVisibleString("Little".getBytes(charset)),
		...
		byte[] expectedBytes = new byte[] { (byte) 0x06, (byte) 0x52, (byte) 0x61, (byte) 0x6E, (byte) 0x64,
				...
				(byte) 0x47, (byte) 0x03, (byte) 0x47, (byte) 0x75, (byte) 0x79, (byte) 0x08, (byte) 0x32, (byte) 0x30,
				(byte) 0x30, (byte) 0x38, (byte) 0x31, (byte) 0x30, (byte) 0x32, (byte) 0x38, (byte) 0x02, (byte) 0x00 };
		...
		AxdrByteArrayOutputStream axdrOS2 = new AxdrByteArrayOutputStream(1000);
