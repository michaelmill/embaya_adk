...
import org.openmuc.jasn1.compiler.someexamples.generated.My_Choice;
import org.openmuc.jasn1.compiler.someexamples.generated.My_Choice2;
import org.openmuc.jasn1.compiler.someexamples.generated.SequenceOfAll;
...
public class SomeExamplesCodingTest {
	...
	public void encodingDecoding() throws IOException {
		...
		SequenceOfAll seq = new SequenceOfAll(new AxdrInteger(-271864), new AxdrInteger(89), new AxdrBoolean(false),
				new AxdrBitString(new byte[] { 0x03 }), new AxdrEnum(253), new AxdrGeneralizedTime(
						new byte[] { 12, 34 }), new AxdrNull(), new AxdrOctetString(new byte[] {}),
